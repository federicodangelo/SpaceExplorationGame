...
public class SpaceStationOverlay : OverlayBase
{
    ...
    public override void Render(Game game)
    {
        ...
        renderer.DrawRectScreen(frameX - 2, frameY - 2, frameW + 4, frameH + 4, new Color4(60, 60, 100, 150));
        renderer.DrawRectScreen(frameX, frameY, frameW, frameH, new Color4(15, 15, 35, 240));

        // Corner accents
        int accentLen = 30;
        renderer.DrawLineScreen(frameX, frameY, frameX + accentLen, frameY, new Color3(100, 180, 255));
        renderer.DrawLineScreen(frameX, frameY, frameX, frameY + accentLen, new Color3(100, 180, 255));
        renderer.DrawLineScreen(frameX + frameW, frameY, frameX + frameW - accentLen, frameY, new Color3(100, 180, 255));
        renderer.DrawLineScreen(frameX + frameW, frameY, frameX + frameW, frameY + accentLen, new Color3(100, 180, 255));
        renderer.DrawLineScreen(frameX, frameY + frameH, frameX + accentLen, frameY + frameH, new Color3(100, 180, 255));
        renderer.DrawLineScreen(frameX, frameY + frameH, frameX, frameY + frameH - accentLen, new Color3(100, 180, 255));
        renderer.DrawLineScreen(frameX + frameW, frameY + frameH, frameX + frameW - accentLen, frameY + frameH, new Color3(100, 180, 255));
        renderer.DrawLineScreen(frameX + frameW, frameY + frameH, frameX + frameW, frameY + frameH - accentLen, new Color3(100, 180, 255));

        // Title
        renderer.DrawTextScreen(frameX + 20, frameY + 20, "SPACE STATION", new Color3(100, 200, 255), 3f);
        renderer.DrawTextScreen(frameX + 20, frameY + 55, _station.Name.ToUpper(), new Color3(200, 200, 200), 2f);
        renderer.DrawTextScreen(frameX + 20, frameY + 80, $"IN SYSTEM: {_starSystem.Name}", new Color3(120, 120, 150), 1.5f);

        // Separator
        renderer.DrawLineScreen(frameX + 20, frameY + 105, frameX + frameW - 20, frameY + 105, new Color3(60, 60, 100));

        // Credits
        renderer.DrawTextScreen(frameX + frameW - 200, frameY + 20, $"CREDITS: {game.Player.Credits}", new Color3(255, 220, 80), 2f);
        ...
        renderer.DrawLineScreen(frameX + 20, statusY, frameX + frameW - 20, statusY, new Color3(60, 60, 100));
        renderer.DrawTextScreen(frameX + 20, statusY + 10, $"SHIP: {game.Player.CurrentShipType.Name.ToUpper()}", new Color3(150, 150, 200), 2f);
        renderer.DrawTextScreen(frameX + 20, statusY + 40, $"HULL: {game.Player.ShipHealth:F0}/{game.Player.ShipMaxHealth:F0}", new Color3(100, 255, 100), 1.5f);
        renderer.DrawTextScreen(frameX + 20, statusY + 60, $"FUEL: {game.Player.ShipFuel:F0}/{game.Player.ShipMaxFuel:F0}", new Color3(100, 200, 255), 1.5f);
        renderer.DrawTextScreen(frameX + 20, statusY + 80, $"[REFUELED +{GameConfig.StationRefuelAmount:F0}]", new Color3(80, 200, 120), 1.5f);
        ...
        // Controls
        renderer.DrawTextScreen(frameX + 20, frameY + frameH - 30, "UP/DOWN: SELECT  ENTER: CONFIRM  ESC: EXIT", new Color3(100, 100, 130), 1.5f);
