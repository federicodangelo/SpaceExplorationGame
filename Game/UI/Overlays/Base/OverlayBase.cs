...
public abstract class OverlayBase
{
    ...
    /// </summary>
    public static void DrawFrame(ISpriteRenderer renderer, float x, float y, float w, float h,
        byte bgAlpha = 230)
    {
    ...
    /// </summary>
    public static void DrawFrameWithHeader(ISpriteRenderer renderer, float x, float y, float w, float h,
